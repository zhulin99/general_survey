...
! function(t, e) {
	...
	function o(t, e, r, n) {
		var o = i(e),
			u = s(r, n),
			l = (t + "?" + o).length;
		if(l <= 2e3 && tt.cors ? u.open("GET", t + "?" + o) : l > 2e3 && tt.cors && (u.open("POST", t), u.setRequestHeader("Content-Type", "application/x-www-form-urlencoded")), "undefined" != typeof n && null !== n && "undefined" != typeof n.options && (u.timeout = n.options.timeout), l <= 2e3 && tt.cors) u.send(null);
		else {
			if(!(l > 2e3 && tt.cors)) return l <= 2e3 && !tt.cors ? a(t, e, r, n) : void R("a request to " + t + " was longer then 2000 characters and this browser cannot make a cross-domain post request. Please use a proxy http://esri.github.io/esri-leaflet/api-reference/request.html");
			u.send(o)
		}
		return u
	}
	...
	function a(t, s, r, n) {
		...
		return a.type = "text/javascript", a.src = t + "?" + i(s), a.id = o, it++, {
			id: o,
			url: a.src,
			abort: function() {
	...
	function _(t, e) {
		var i = {};
		return "number" == typeof t.x && "number" == typeof t.y && (i.type = "Point", i.coordinates = [t.x, t.y]), t.points && (i.type = "MultiPoint", i.coordinates = t.points.slice(0)), t.paths && (1 === t.paths.length ? (i.type = "LineString", i.coordinates = t.paths[0].slice(0)) : (i.type = "MultiLineString", i.coordinates = t.paths.slice(0))), t.rings && (i = f(t.rings.slice(0))), (t.geometry || t.attributes) && (i.type = "Feature", i.geometry = t.geometry ? _(t.geometry) : null, i.properties = t.attributes ? v(t.attributes) : null, t.attributes && (i.id = t.attributes[e] || t.attributes.OBJECTID || t.attributes.FID)), i
	}
	...
	function b(t, e) {
		...
		switch(t.type) {
			...
			case "MultiPolygon":
				...
				break;
			case "Feature":
				t.geometry && (r.geometry = b(t.geometry, e)), r.attributes = t.properties ? v(t.properties) : {}, t.id && (r.attributes[e] = t.id);
				break;
	...
	function F(t) {
		return t.getSize().x - et.attributionWidthOffset + "px"
	}
	...
	var X = "2.0.7",
		...
		Y = "" === document.documentElement.style.pointerEvents,
		tt = {
			cors: $,
			pointerEvents: Y
		},
	...
	var rt = {
		...
		ot = e.Class.extend({
			...
			initialize: function(t) {
				if(t.request && t.options ? (this._service = t, e.Util.setOptions(this, t.options)) : (e.Util.setOptions(this, t), this.options.url = w(t.url)), this.params = e.Util.extend({}, this.params || {}), this.setters)
			...
			_request: function(t, e, i, s, r) {
				...
				return "get" !== t && "request" !== t || this.options.useCors ? rt[t](n, i, s, r) : rt.get.JSONP(n, i, s, r)
			}
		}),
		at = ot.extend({
			setters: {
			...
			run: function(t, e) {
				return this._cleanParams(), this.options.isModern || nt.isArcgisOnline(this.options.url) ? (this.params.f = "geojson", this.request(function(i, s) {
					this._trapSQLerrors(i), t.call(e, i, s, s)
				}, this)) : this.request(function(i, s) {
					this._trapSQLerrors(i), t.call(e, i, s && nt.responseToFeatureCollection(s), s)
				}, this)
			},
			count: function(t, e) {
			...
			bounds: function(t, e) {
				return this._cleanParams(), this.params.returnExtentOnly = !0, this.request(function(i, s) {
					s && s.extent && nt.extentToBounds(s.extent) ? t.call(e, i, nt.extentToBounds(s.extent), s) : (i = {
			...
			_trapSQLerrors: function(t) {
				t && "400" === t.code && nt.warn("one common syntax error in query requests is encasing string values in double quotes instead of single quotes")
			},
			...
			_setGeometry: function(t) {
				return this.params.inSr = 4326, t instanceof e.LatLngBounds ? (this.params.geometry = nt.boundsToExtent(t), void(this.params.geometryType = "esriGeometryEnvelope")) : (t.getLatLng && (t = t.getLatLng()), t instanceof e.LatLng && (t = {
					type: "Point",
					coordinates: [t.lng, t.lat]
				}), t instanceof e.GeoJSON && (t = t.getLayers()[0].feature.geometry, this.params.geometry = nt.geojsonToArcGIS(t), this.params.geometryType = nt.geojsonTypeToArcGIS(t.type)), t.toGeoJSON && (t = t.toGeoJSON()), "Feature" === t.type && (t = t.geometry), "Point" === t.type || "LineString" === t.type || "Polygon" === t.type || "MultiPolygon" === t.type ? (this.params.geometry = nt.geojsonToArcGIS(t), void(this.params.geometryType = nt.geojsonTypeToArcGIS(t.type))) : void nt.warn("invalid geometry passed to spatial query. Should be L.LatLng, L.LatLngBounds, L.Marker or a GeoJSON Point, Line, Polygon or MultiPolygon object"))
			}
		}),
		ut = ot.extend({
			setters: {
			...
			run: function(t, e) {
				return this.request(function(i, s) {
					t.call(e, i, s && nt.responseToFeatureCollection(s), s)
				}, e)
			}
		}),
		lt = ot.extend({
		...
		ht = lt.extend({
			...
			on: function(t) {
				var e = nt.boundsToExtent(t.getBounds()),
					i = t.getSize();
			...
			run: function(t, e) {
				return this.request(function(i, s) {
					...
					var r = nt.responseToFeatureCollection(s);
		...
		ct = lt.extend({
			...
			_responseToGeoJSON: function(t) {
				...
				if(t.properties && t.properties.Values && (r.pixel.properties.values = t.properties.Values), i && i.features && (r.catalogItems = nt.responseToFeatureCollection(i), s && s.length === r.catalogItems.features.length))
		...
		pt = e.Evented.extend({
			...
			initialize: function(t) {
				t = t || {}, this._requestQueue = [], this._authenticating = !1, e.Util.setOptions(this, t), this.options.url = w(this.options.url)
			},
			...
			_request: function(t, e, i, s, r) {
				...
				return "get" !== t && "request" !== t || this.options.useCors ? rt[t](o, i, n, r) : rt.get.JSONP(o, i, n, r)
			},
		...
		ft = pt.extend({
			...
			addFeature: function(t, e, i) {
				return delete t.id, t = L(t), this.post("addFeatures", {
					features: [t]
				}, function(t, s) {
			...
			updateFeature: function(t, e, i) {
				return t = L(t, this.options.idAttribute), this.post("updateFeatures", {
					features: [t]
				}, function(t, s) {
		...
		yt = "https:" !== window.location.protocol ? "http:" : "https:",
		gt = e.TileLayer.extend({
			statics: {
				TILES: {
					Streets: {
					...
					Topographic: {
						urlTemplate: yt + "//{s}.arcgisonline.com/ArcGIS/rest/services/World_Topo_Map/MapServer/tile/{z}/{y}/{x}",
						options: {
							minZoom: 1,
							maxZoom: 19,
							subdomains: ["server", "services"],
					...
					Oceans: {
						urlTemplate: yt + "//{s}.arcgisonline.com/arcgis/rest/services/Ocean/World_Ocean_Base/MapServer/tile/{z}/{y}/{x}",
						options: {
							minZoom: 1,
							maxZoom: 16,
							subdomains: ["server", "services"],
					...
					OceansLabels: {
						urlTemplate: yt + "//{s}.arcgisonline.com/arcgis/rest/services/Ocean/World_Ocean_Reference/MapServer/tile/{z}/{y}/{x}",
						options: {
							minZoom: 1,
							maxZoom: 16,
							subdomains: ["server", "services"],
							pane: Y ? "esri-labels" : "tilePane"
						}
					},
					NationalGeographic: {
						urlTemplate: yt + "//{s}.arcgisonline.com/ArcGIS/rest/services/NatGeo_World_Map/MapServer/tile/{z}/{y}/{x}",
						options: {
							minZoom: 1,
							maxZoom: 16,
							subdomains: ["server", "services"],
					...
					DarkGray: {
						urlTemplate: yt + "//{s}.arcgisonline.com/ArcGIS/rest/services/Canvas/World_Dark_Gray_Base/MapServer/tile/{z}/{y}/{x}",
						options: {
							minZoom: 1,
							maxZoom: 16,
							subdomains: ["server", "services"],
					...
					DarkGrayLabels: {
						urlTemplate: yt + "//{s}.arcgisonline.com/ArcGIS/rest/services/Canvas/World_Dark_Gray_Reference/MapServer/tile/{z}/{y}/{x}",
						options: {
							minZoom: 1,
							maxZoom: 16,
							subdomains: ["server", "services"],
					...
					Gray: {
						urlTemplate: yt + "//{s}.arcgisonline.com/ArcGIS/rest/services/Canvas/World_Light_Gray_Base/MapServer/tile/{z}/{y}/{x}",
						options: {
							minZoom: 1,
							maxZoom: 16,
							subdomains: ["server", "services"],
					...
					GrayLabels: {
						urlTemplate: yt + "//{s}.arcgisonline.com/ArcGIS/rest/services/Canvas/World_Light_Gray_Reference/MapServer/tile/{z}/{y}/{x}",
						options: {
							minZoom: 1,
							maxZoom: 16,
							subdomains: ["server", "services"],
					...
					Imagery: {
						urlTemplate: yt + "//{s}.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}",
						options: {
							minZoom: 1,
							maxZoom: 19,
							subdomains: ["server", "services"],
					...
					ImageryLabels: {
						urlTemplate: yt + "//{s}.arcgisonline.com/ArcGIS/rest/services/Reference/World_Boundaries_and_Places/MapServer/tile/{z}/{y}/{x}",
						options: {
							minZoom: 1,
							maxZoom: 19,
							subdomains: ["server", "services"],
					...
					ImageryTransportation: {
						urlTemplate: yt + "//{s}.arcgisonline.com/ArcGIS/rest/services/Reference/World_Transportation/MapServer/tile/{z}/{y}/{x}",
						options: {
							minZoom: 1,
							maxZoom: 19,
							subdomains: ["server", "services"],
					...
					ShadedRelief: {
						urlTemplate: yt + "//{s}.arcgisonline.com/ArcGIS/rest/services/World_Shaded_Relief/MapServer/tile/{z}/{y}/{x}",
						options: {
							minZoom: 1,
							maxZoom: 13,
							subdomains: ["server", "services"],
					...
					ShadedReliefLabels: {
						urlTemplate: yt + "//{s}.arcgisonline.com/ArcGIS/rest/services/Reference/World_Boundaries_and_Places_Alternate/MapServer/tile/{z}/{y}/{x}",
						options: {
							minZoom: 1,
							maxZoom: 12,
							subdomains: ["server", "services"],
					...
					Terrain: {
						urlTemplate: yt + "//{s}.arcgisonline.com/ArcGIS/rest/services/World_Terrain_Base/MapServer/tile/{z}/{y}/{x}",
						options: {
							minZoom: 1,
							maxZoom: 13,
							subdomains: ["server", "services"],
					...
					TerrainLabels: {
						urlTemplate: yt + "//{s}.arcgisonline.com/ArcGIS/rest/services/Reference/World_Reference_Overlay/MapServer/tile/{z}/{y}/{x}",
						options: {
							minZoom: 1,
							maxZoom: 13,
							subdomains: ["server", "services"],
					...
					USATopo: {
						urlTemplate: yt + "//{s}.arcgisonline.com/ArcGIS/rest/services/USA_Topo_Maps/MapServer/tile/{z}/{y}/{x}",
						options: {
							minZoom: 1,
							maxZoom: 15,
							subdomains: ["server", "services"],
			...
			initialize: function(t, i) {
				...
				if("object" == typeof t && t.urlTemplate && t.options) s = t;
					...
					if("string" != typeof t || !gt.TILES[t]) throw new Error('L.esri.BasemapLayer: Invalid parameter. Use one of "Streets", "Topographic", "Oceans", "OceansLabels", "NationalGeographic", "Gray", "GrayLabels", "DarkGray", "DarkGrayLabels", "Imagery", "ImageryLabels", "ImageryTransportation", "ShadedRelief", "ShadedReliefLabels", "Terrain", "TerrainLabels" or "USATopo"');
					s = gt.TILES[t]
				}
			...
			onAdd: function(t) {
				P(t), "esri-labels" === this.options.pane && this._initPane(), this.options.attributionUrl && k(this.options.attributionUrl, t), t.on("moveend", M), e.TileLayer.prototype.onAdd.call(this, t)
			},
			onRemove: function(t) {
		...
		vt = e.TileLayer.extend({
			...
			initialize: function(t) {
				t.url = w(t.url), t = e.Util.setOptions(this, t), this.tileUrl = t.url + "tile/{z}/{y}/{x}", this.service = N(t), this.service.addEventParent(this);
			...
			createTile: function(t, i) {
				...
				return e.DomEvent.on(s, "load", e.bind(this._tileOnLoad, this, i, s)), e.DomEvent.on(s, "error", e.bind(this._tileOnError, this, i, s)), this.options.crossOrigin && (s.crossOrigin = ""), s.alt = "", !this._lodMap || this._lodMap && this._lodMap[this._getZoomForUrl()] ? s.src = this.getTileUrl(t) : this.once("lodmap", function() {
					s.src = this.getTileUrl(t)
				}, this), s
			},
			onAdd: function(t) {
				P(t), this._lodMap || this.metadata(function(i, s) {
					if(!i && s.spatialReference) {
						var r = s.spatialReference.latestWkid || s.spatialReference.wkid;
						if(!this.options.attribution && t.attributionControl && s.copyrightText && (this.options.attribution = s.copyrightText, t.attributionControl.addAttribution(this.getAttribution())), t.options.crs === e.CRS.EPSG3857 && 102100 === r || 3857 === r) {
							this._lodMap = {};
							for(var n = s.tileInfo.lods, o = vt.MercatorZoomLevels, a = 0; a < n.length; a++) {
								var u = n[a];
								for(var l in o) {
									var h = o[l];
							...
							this.fire("lodmap")
						} else proj4 || R("L.esri.TiledMapLayer is using a non-mercator spatial reference. Support may be available through Proj4Leaflet http://esri.github.io/esri-leaflet/examples/non-mercator-projection.html")
					}
		...
		bt = e.Layer.extend({
			...
			onAdd: function(t) {
				P(t), this._update = e.Util.throttle(this._update, this.options.updateInterval, this), t.on("moveend", this._update, this), this._currentImage && this._currentImage._bounds.equals(this._map.getBounds()) ? t.addLayer(this._currentImage) : this._currentImage && (this._map.removeLayer(this._currentImage), this._currentImage = null), this._update(), this._popup && (this._map.on("click", this._getPopupData, this), this._map.on("dblclick", this._resetPopupState, this)), this.metadata(function(e, i) {
			...
			_update: function() {
				if(this._map) {
					...
					if(!(this._animatingZoom || this._map._panTransition && this._map._panTransition._inProgress)) {
						if(t > this.options.maxZoom || t < this.options.minZoom) return void(this._currentImage && this._currentImage._map.removeLayer(this._currentImage));
		...
		Lt = bt.extend({
			...
			initialize: function(t) {
				t.url = w(t.url), this.service = j(t), this.service.addEventParent(this), e.Util.setOptions(this, t)
			},
			...
			_buildExportParams: function() {
				...
				var o = parseInt(this._map.options.crs.code.split(":")[1], 10),
					a = {
		...
		xt = bt.extend({
			...
			initialize: function(t) {
				t.url = w(t.url), this.service = N(t), this.service.addEventParent(this), (t.proxy || t.token) && "json" !== t.f && (t.f = "json"), e.Util.setOptions(this, t)
			},
			...
			_buildExportParams: function() {
				var t = this._map.getBounds(),
					...
					n = this._map.latLngToLayerPoint(t._northEast),
					o = this._map.latLngToLayerPoint(t._southWest);
		...
		St = e.Layer.extend({
			...
			_addCells: function(t) {
				...
				for(i = t.min.y; i <= t.max.y; i++)
					for(s = t.min.x; s <= t.max.x; s++) r = e.point(s, i), r.z = a, this._isValidCell(r) && n.push(r);
				var u = n.length;
				if(0 !== u)
	...
	V.prototype.query = function(t) {
	...
	}, V.prototype.getIndex = function(t) {
		...
		return Math.abs(~r)
	}, V.prototype.between = function(t, e) {
	...
	}, V.prototype.insert = function(t) {
		return this.values.splice(this.getIndex(t.value), 0, t), this
	}, V.prototype.bulkAdd = function(t, e) {
	...
	var At = St.extend({
			...
			initialize: function(t) {
				if(St.prototype.initialize.call(this, t), t.url = w(t.url), t = e.setOptions(this, t), this.service = Z(t), this.service.addEventParent(this), "*" !== this.options.fields[0]) {
					for(var i = !1, s = 0; s < this.options.fields.length; s++) this.options.fields[s].match(/^(OBJECTID|FID|OID|ID)$/i) && (i = !0);
					i === !1 && R("no known esriFieldTypeOID field detected in fields Array.  Please add an attribute field containing unique IDs to ensure the layer can be drawn correctly.")
				}
				this.options.timeField.start && this.options.timeField.end ? (this._startTimeIndex = new V, this._endTimeIndex = new V) : this.options.timeField && (this._timeIndex = new V), this._cache = {}, this._currentSnapshot = [], this._activeRequests = 0
			},
			onAdd: function(t) {
				return P(t), this.service.metadata(function(e, i) {
					if(!e) {
				...
				}, this), t.on("zoomend", this._handleZoomChange, this), St.prototype.onAdd.call(this, t)
			},
			onRemove: function(t) {
				return t.off("zoomend", this._handleZoomChange, this), St.prototype.onRemove.call(this, t)
			},
			getAttribution: function() {
				return this.options.attribution
			},
			...
			_addFeatures: function(t, e) {
				...
				for(var s = t.length - 1; s >= 0; s--) {
					var r = t[s].id;
					this._currentSnapshot.push(r), this._cache[i].push(r)
				}
		...
		Tt = At.extend({
			...
			initialize: function(t) {
				At.prototype.initialize.call(this, t), this._originalStyle = this.options.style, this._layers = {}
			},
			onRemove: function(t) {
				...
				return At.prototype.onRemove.call(this, t)
			},
