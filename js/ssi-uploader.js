...
//----------------------------UPLOADFILES------------------------------------
    ...
    var locale = {
        ...
        china: {
            ...
            clear: '清除所有',
            drag: '请将照片拖拽至此...',
            sizeError: '$1 文件大小应小于 $2',// $1=file name ,$2=max ie( example.jpg has has exceed the size limit of 2mb)
            extError: '$1 不是所支持的文件类型',//$1=file extension ie(exe files are not supported)
            someErrorsOccurred: '未知错误!'
        }
    };
