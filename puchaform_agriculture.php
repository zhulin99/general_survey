...
<head>
    ...
    <script type="text/javascript" src="js/puchaform_agriculture.js"></script>
...
<div class="panel admin-panel">
  <div class="puchaform_form_head">普查表单-农业源</div>
      ...
      <form class="puchaform_base">
          ...
          <fieldset>
              ...
              <div class="item">
                  ...
                  <div class="right"><input type="text" name="nh3" /></div>
              </div>
          </fieldset>
